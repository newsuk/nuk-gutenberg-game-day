...
const chartData = feedCategories => ({
  ...
  datasets: [{
    ...
    backgroundColor: ['rgba(31, 119, 180, 1)', 'rgba(255, 127, 14, 1)', 'rgba(44, 160, 44, 1)', 'rgba(214, 39, 40, 1)', 'rgba(148, 103, 189, 1)', 'rgba(255, 194, 10, 1)', 'rgba(23, 190, 207, 1)', 'rgba(227, 119, 194, 1)', 'rgba(127, 127, 127, 1)', 'rgba(140, 86, 75, 1)'],
    borderWidth: 1
  }]
});
const PieChart = ({
  feedCategories
}) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_chartjs_2__WEBPACK_IMPORTED_MODULE_2__.Pie, {
  data: chartData(feedCategories)
});
...
/* harmony import */ var _pie__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pie */ "./src/pie.js");
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  chartContainers.forEach(container => {
    const feedCategories = JSON.parse(container.getAttribute('data-feed-categories'));
    (0,react_dom__WEBPACK_IMPORTED_MODULE_0__.render)(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_pie__WEBPACK_IMPORTED_MODULE_1__.PieChart, {
